 ...
 */
package com.epistimis.face.template.ui.wizard
 ...
 */
class TemplateProjectTemplateProvider implements IProjectTemplateProvider {
...
<p>This is a parameterized hello world for Template. You can set a parameter to modify the content in the generated file
...
final class HelloWorldProject {
	...
	override generateProjects(IProjectGenerator generator) {
		generator.generate(new PluginProjectFactory => [
			...
			folders += "src"
			addFile('''src/«path»/Model.template''', '''
				/*
